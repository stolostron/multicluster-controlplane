...
func NewEmbeddedEtcdOptions() *EmbeddedEtcdOptions {
	return &EmbeddedEtcdOptions{
		Directory:  ".embedded-etcd",
		PeerPort:   "2380",
		ClientPort: "2379",
	}
}

func (e *EmbeddedEtcdOptions) addFlags(fs *pflag.FlagSet) {
...
func (e *EmbeddedEtcdOptions) Validate() []error {
	var errs []error
	if e.Enabled {
		if e.PeerPort == "" {
