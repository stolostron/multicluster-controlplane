...
func (c *ClusterClaimer) isOpenShift() (bool, error) {
	...
	if err != nil {
		klog.Infof("failed to mapping OCP projects, %v", err)
		return false, nil
	}
...
func (c *ClusterClaimer) isOpenshiftDedicated() (bool, error) {
	...
	if err != nil {
		klog.Infof("failed to mapping dedicated OCP subjectpermissions, %v", err)
		return false, nil
	}
	return true, nil
}
...
func (c *ClusterClaimer) isARO() (bool, error) {
	...
	if err != nil {
		klog.Infof("failed to mapping ARO cluster, %v", err)
		return false, nil
	}
	return true, nil
}
